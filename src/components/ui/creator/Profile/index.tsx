...
function PageRenderer({ page, onNav, onViewUser, user, plans, features, notification, orderList, memberList, blockList, categories }: PageRendererProps) {
  switch (page) {
...
export default function CreatorProfile({ user, plans, features, notification, orderList, memberList, blockList, categories }: { user: any, plans: Plan[], features: string[], notification: any, orderList: any[], memberList: any[], blockList: any[], categories: VibeCategory[] }) {
  ...
  return (
    <div className="bg-[#0f1020]">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6">
        <PageRenderer page={page} onNav={navigate} onViewUser={handleViewUser} user={user} plans={plans} features={features} notification={notification} orderList={orderList} memberList={memberList} blockList={blockList} categories={categories} />
      </div>
    </div>
  );
}